...
export default function UpdateForm() {
  ...
  useEffect(() => {
    if (contactId) {
      fetch(`http://localhost/contact-management-system/Backend_Components/PHP/crudcontact/fetchContact.php?id=${contactId}`)
  ...
  async function updateContactDataHandler(data) {
    ...
    try {
      ...
      const url = `http://localhost/contact-management-system/Backend_Components/PHP/crudcontact/updateContact.php?id=${data.id}`;
